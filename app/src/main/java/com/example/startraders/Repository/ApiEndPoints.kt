...
interface ApiEndPoints {
    ...
    fun retrieveCustomerDiscountDates(@Part partMap : List<MultipartBody.Part>) :
            Call<ArrayList<CustomerDiscountDates>>

    @Multipart
    @POST("GetInvoiceByCustomer")
    fun retrieveCustomerPrevBill(@Part partMap : List<MultipartBody.Part>) :
            Call<ArrayList<CustomerDiscountDates>>

    @Multipart
    @POST("OutStandingBalance")
    fun retrieveCustomerBalance(@Part partMap : List<MultipartBody.Part>) :
            Call<ArrayList<CustomerOutResponse>>
